...
namespace QLST
{
    class rptHoaDonBanHang
    {
        ...
        // Bang hang
        public const string T_HD_BANHANG = "HoaDonBanHang";
        #endregion
        ...
        private const string MAHD = "%MAHD";
        private const string TENNV = "%TENNV";
        private const string TENKH = "%TENKH";
        private const string TONGTH = "%TONGTH";
        private const string TONGTT = "%TONGTT";
        private const string TICHDIEM = "%TICHDIEM";
        private const string DUNGDIEM = "%DUNGDIEM";
        private const string TIENMAT = "%TIENMAT";
        private const string TRALAI = "%TRALAI";
        private const string DTL = "%DTL";
        #endregion
        ...
        private void BuildReplacerCurrentDate(ref Dictionary<string, string> pReplacer)
        {
            if (pReplacer != null)
            {
                ...
                string ngay = currentDate.Day + " / " + currentDate.Month + " / " + currentDate.Year;
                pReplacer.Add("%NGAYLAP", ngay);
            }
        }
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_HD_BANHANG:
                    ...
                    arrByte = File.ReadAllBytes("HoaDonBanHang.xls").ToArray();
                    break;
                #endregion
            }
            // Get stream
